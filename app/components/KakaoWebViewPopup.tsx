  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="relative w-[80%] max-w-md bg-white rounded-lg p-4">
        <div className='text-center text-2xl font-bold text-gray-600 my-2'>카카오톡 웹뷰 공지</div>
        ...
        />
        <div className='text-center mt-2'>로그인 서비스 이용 시 <span className='text-red-500 font-bold'>다른 브라우저로 열기</span> 를 선택해주세요.</div>
        <button
          onClick={handleClose}
