      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <div className="bg-white shadow-md rounded-lg p-4 hover:shadow-lg transition duration-300">
          ...
          <p className="text-gray-700 mb-4">
            ...
            <br />
            <strong>호드네임(Hoard Name)</strong>은 Ha-Nam 과 Board game 의
            합성어 입니다.
            <br />
            <br />
            ...
            <br />
            <strong>2.2.</strong> 월회원으로 등록한 회원은 (월)을 붙여 표시한다.
            ex)김밥.남.망월(월)
            <br />
            <br />
            <strong>3. 위반되는 행위에 대한 방침</strong>
            <br />
            온라인/오프라인을 불문하고 아래와 같은 내용 또는 그 내용에 준하는
            행위를 했다고 판단되는 회원은 매니저(방장) 또는 부매니저가 경고 부여
            또는 즉시 제명한다.
            <br />
            ...
            <br />
            모임 참여자들과 협의나 소통을 하지 않고 잦은 노쇼나 지각으로 인해
            모임 진행에 차질을 주는 자
            <br />
            <strong>3.5. 기타</strong>
            <br />그 밖에 관리자 또는 회원 간 동의하에 경고 부여 또는 제명이
            필요하다고 판단되는 자
          </p>
        </div>
        <div className="bg-white shadow-md rounded-lg p-4 hover:shadow-lg transition duration-300">
          ...
          <p className="text-gray-700 mb-4">
            <strong>1.</strong> 채팅방 상단 고정된 &apos;N월 N주차 투표&apos;
            클릭
            <br />
            → 해당 날짜에 투표
            <br />
            ...
            * 해당 모임 날짜에 월회원 1명 이상 필요
            ...
            <br />
            <br />
            <strong>3.</strong> 기존 참석자가 있다면 @닉네임으로 태그 걸어
            알려주기
            <br />
        ...
        <div className="flex flex-col space-y-4">
          ...
          <div className="bg-white shadow-md rounded-lg p-4 hover:shadow-lg h-full transition duration-300">
            <p className="text-gray-700 mb-4">
              ...
              <br />
              <strong>2.</strong> 모임 주도자는 모임 2일 전이나 당일 반드시
              일정을 취합하시기 바랍니다.
              <br />
              <strong>3.</strong> 투표한 인원은 모임 참여자의 @멘션에 반드시
              회신하시기 바랍니다.
              <br />
              <strong>4.</strong> 회칙 제3조 제4항에 따라 협의 및 소통 없는
              지각과 노쇼 1회 시 경고 조치를 가하며, 이후 n회 누적 시 아지트
              사용을 제재합니다.
            </p>
          </div>
        </div>
